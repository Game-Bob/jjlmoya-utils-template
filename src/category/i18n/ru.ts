...
const description = 'Бесплатные инструменты для настольных и ролевых игр: виртуальные кости со статистикой и таймер ходов. Работает в браузере, без регистрации и с приватными данными.';
